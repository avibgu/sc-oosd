...
import data.config.filter.FilterByAuthor;
import data.config.filter.FilterByCategory;
import data.config.filter.FilterByContent;
import data.config.filter.FilterByTitle;
import data.config.format.RssFormat;
import data.config.format.TextFormat;
